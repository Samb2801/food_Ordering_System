...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/SB.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/SB.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="images/SB.png">
  <!-- For Windows Phone -->
...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/log.png"/ width= "10" height ="60"  alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Food Ordering System <a class="grey-text text-lighten-4" href="#" target="_blank"></a> </span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Samarth</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
